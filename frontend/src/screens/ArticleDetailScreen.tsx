          ...
          if (part.isHighlighted && part.hanja) {
            return (
              <Text
                ...
                onPress={() => handleHanjaPress(part.hanja!)}
              >
                {part.text}
              </Text>
            );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerButtons}>
          ...
          <TouchableOpacity
            onPress={handleSave}
            style={[styles.headerButton, isSaved && styles.savedButtonBorder]}
          >
            <Text style={[styles.headerButtonText, isSaved && styles.savedButtonText]}>
              {isSaved ? "저장됨" : "저장"}
            </Text>
          </TouchableOpacity>
        </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.articleMeta}>
          ...
          <View style={styles.summaryLevelContainer}>
            ...
            <TouchableOpacity style={styles.summaryLevelButton} onPress={handleSummaryLevelChange}>
